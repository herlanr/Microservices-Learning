...
* The original package name 'com.herlan.microservices.spring-cloud-config-server' is invalid and this project uses 'com.herlan.microservices.spring_cloud_config_server' instead.
